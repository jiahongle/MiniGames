					...
					<table>
						...
						<tr>
							...
							<td><input <?php if (isset($pwErr)) echo "class='err'"; ?> 
									type="password" name="password" placeholder="Enter New Password"/></td>
							<td class='errorMsg'><?php if (isset($pwErr)) echo $pwErr;?></td>
						</tr>
						<tr>
							<th><label for="psw-repeat">Repeat New Password</label></th>
							<td><input <?php if (isset($rptPwErr)) echo "class='err'"; ?> 
									type="password" name="psw-repeat" placeholder="Re-Enter New Password"/></td>
						...
						<tr>
							...
							<td>
								...
								<label for="terms">I understand that clicking "Update Profile" will potentially change my credentials.</label>
							</td>
						</tr>
						<tr>
							<th>&nbsp;</th>
						...
						<tr>
							...
							<td>
								<?php 
									if (count($errors) == 0 && isset($_REQUEST['submit']) 
